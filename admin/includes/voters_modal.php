            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="voters_add.php" enctype="multipart/form-data">
                <div class="form-group">
                    <label for="matric_no" class="col-sm-3 control-label">Matric Number</label>
                    <div class="col-sm-9">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="voters_edit.php">
                ...
                <div class="form-group">
                    <label for="edit_matric_no" class="col-sm-3 control-label">Matric Number</label>

                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="edit_matric_no" name="matric_no">
                    </div>
                </div>
                <div class="form-group">
